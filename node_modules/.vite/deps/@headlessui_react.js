...
function $3ef42575df84b30b$export$9d1611c77c2fe928(...args) {
  ...
  for (let i16 = 1; i16 < args.length; i16++) {
    ...
    for (let key in props) {
      ...
      else if (key === "ref" && a28 && b14) result.ref = (0, $5dc95899b306f630$export$c9058316764c140e)(a28, b14);
...
function $bbed8b41f857bcc0$var$setupGlobalEvents() {
  ...
  let onTransitionStart = (e9) => {
    let eventTarget = (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9);
    if (!isTransitionEvent(e9) || !eventTarget) return;
...
function $8a9cb279dc87e130$export$cabe61c495ee3649(target) {
  ...
  let onBlur = (e9) => {
    if ((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9) === activeElement2 || isRefocusing) e9.stopImmediatePropagation();
  };
  let onFocusOut = (e9) => {
    if ((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9) === activeElement2 || isRefocusing) {
  ...
  let onFocus = (e9) => {
    if ((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9) === target || isRefocusing) e9.stopImmediatePropagation();
  };
  let onFocusIn = (e9) => {
    if ((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9) === target || isRefocusing) {
      e9.stopImmediatePropagation();
      if (!isRefocusing) {
        isRefocusing = true;
        (0, $7215afc6de606d6b$export$de79e2c695e052f3)(activeElement2);
...
function $f6c31cce2adf654f$export$45712eceda6fad21(props) {
    ...
    if (isElemKeyPressed) {
      let onKeyUp = (e9) => {
        ...
        if (state.isPressed && state.target && $f6c31cce2adf654f$var$isValidKeyboardEvent(e9, state.target)) {
          ...
          let wasPressed = (0, $d4ee10de306f2510$export$4282f70798064fe0)(state.target, target);
  ...
  (0, $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c)(() => {
    ...
    if (isPointerPressed === "pointer") {
      let onPointerUp = (e9) => {
        if (e9.pointerId === state.activePointerId && state.isPressed && e9.button === 0 && state.target) {
          if ((0, $d4ee10de306f2510$export$4282f70798064fe0)(state.target, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9)) && state.pointerType != null) {
            ...
            if (e9.currentTarget) addGlobalListener(e9.currentTarget, "click", () => clicked = true, true);
      ...
      let onMouseUp = (e9) => {
        ...
        if (state.target && (0, $d4ee10de306f2510$export$4282f70798064fe0)(state.target, e9.target) && state.pointerType != null) ;
        else cancelEvent(e9);
        state.isOverTarget = false;
      };
  ...
  let pressProps = (0, import_react25.useMemo)(() => {
    ...
    let pressProps2 = {
      onKeyDown(e9) {
        if ($f6c31cce2adf654f$var$isValidKeyboardEvent(e9.nativeEvent, e9.currentTarget) && (0, $d4ee10de306f2510$export$4282f70798064fe0)(e9.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9))) {
          var _state_metaKeyEvents;
          if ($f6c31cce2adf654f$var$shouldPreventDefaultKeyboard((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9), e9.key)) e9.preventDefault();
          let shouldStopPropagation = true;
      ...
      onClick(e9) {
        if (e9 && !(0, $d4ee10de306f2510$export$4282f70798064fe0)(e9.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9))) return;
    ...
    if (typeof PointerEvent !== "undefined") {
      pressProps2.onPointerDown = (e9) => {
        if (e9.button !== 0 || !(0, $d4ee10de306f2510$export$4282f70798064fe0)(e9.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9))) return;
        ...
        if (!state.isPressed) {
          ...
          if ("releasePointerCapture" in target) {
            if ("hasPointerCapture" in target) {
              if (target.hasPointerCapture(e9.pointerId)) target.releasePointerCapture(e9.pointerId);
            } else target.releasePointerCapture(e9.pointerId);
          }
        }
        if (shouldStopPropagation) e9.stopPropagation();
      };
      pressProps2.onMouseDown = (e9) => {
        if (!(0, $d4ee10de306f2510$export$4282f70798064fe0)(e9.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9))) return;
        if (e9.button === 0) {
      ...
      pressProps2.onPointerUp = (e9) => {
        if (!(0, $d4ee10de306f2510$export$4282f70798064fe0)(e9.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9)) || state.pointerType === "virtual") return;
...
function $507fabe10e71c6fb$var$triggerChangeHandlers(modality, e9) {
  for (let handler of $507fabe10e71c6fb$export$901e90a13c50a14e) handler(modality, e9);
}
...
function $507fabe10e71c6fb$var$handleFocusEvent(e9) {
  if ((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9) === window || (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9) === document || (0, $8a9cb279dc87e130$export$fda7da73ab5d4c48) || !e9.isTrusted) return;
...
function $507fabe10e71c6fb$var$isKeyboardFocusEvent(isTextInput, modality, e9) {
  let document1 = (0, $431fbd86ca7dc216$export$b204af158042fbac)(e9 ? (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9) : void 0);
  let eventTarget = e9 ? (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9) : void 0;
...
function $a1ea59d68270f0dd$export$f8168d8dd8fd66e6(props) {
  ...
  const onBlur = (0, import_react27.useCallback)((e9) => {
    if ((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9) === e9.currentTarget) {
  ...
  const onFocus = (0, import_react27.useCallback)((e9) => {
    ...
    if (eventTarget === e9.currentTarget && eventTarget === activeElement2) {
...
var $f1ab8c75478c6f73$export$3351871ee4b288b8 = (0, import_react30.default).forwardRef(({ children, ...props }, ref) => {
  ...
  context.ref = (0, $df56164dff5785e2$export$4338b53315abf666)(ref || (prevContext === null || prevContext === void 0 ? void 0 : prevContext.ref));
  (0, $e7801be82b4b2a53$export$4debdb1a3f0fa79e)(prevContext, context.ref);
...
function $9ab94262bd0047c7$export$420e68273165f4ec(props) {
  ...
  let onBlur = (0, import_react31.useCallback)((e9) => {
    if (!(0, $d4ee10de306f2510$export$4282f70798064fe0)(e9.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9))) return;
    if (state.current.isFocusWithin && !(0, $d4ee10de306f2510$export$4282f70798064fe0)(e9.currentTarget, e9.relatedTarget)) {
  ...
  let onFocus = (0, import_react31.useCallback)((e9) => {
    ...
    if (!state.current.isFocusWithin && activeElement2 === eventTarget) {
      ...
      addGlobalListener(ownerDocument, "focus", (e10) => {
        let eventTarget2 = (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e10);
...
function $6179b936705e76d3$export$ae780daf29e6d456(props) {
  ...
  let { hoverProps, triggerHoverEnd } = (0, import_react32.useMemo)(() => {
    let triggerHoverStart = (event, pointerType) => {
      ...
      if (isDisabled2 || pointerType === "touch" || state.isHovered || !(0, $d4ee10de306f2510$export$4282f70798064fe0)(event.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(event))) return;
      state.isHovered = true;
      let target = event.currentTarget;
      state.target = target;
      addGlobalListener((0, $431fbd86ca7dc216$export$b204af158042fbac)((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(event)), "pointerover", (e9) => {
        if (state.isHovered && state.target && !(0, $d4ee10de306f2510$export$4282f70798064fe0)(state.target, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9))) triggerHoverEnd2(e9, e9.pointerType);
      }, {
        capture: true
      });
    ...
    if (typeof PointerEvent !== "undefined") {
      ...
      hoverProps2.onPointerLeave = (e9) => {
        if (!isDisabled2 && (0, $d4ee10de306f2510$export$4282f70798064fe0)(e9.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9))) triggerHoverEnd2(e9, e9.pointerType);
      };
    } else if (false) {
      ...
      hoverProps2.onMouseLeave = (e9) => {
        if (!isDisabled2 && (0, $d4ee10de306f2510$export$4282f70798064fe0)(e9.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e9))) triggerHoverEnd2(e9, "mouse");
      };
    }
    return {
...
function $9bf71ea28793e738$var$isElementInScope(element, scope) {
  ...
  return scope.some((node) => (0, $d4ee10de306f2510$export$4282f70798064fe0)(node, element));
}
...
var computePosition = async (reference, floating, config) => {
  ...
  for (let i16 = 0; i16 < middleware.length; i16++) {
    const currentMiddleware = middleware[i16];
...
function getClippingRect(_ref) {
  ...
  for (let i16 = 1; i16 < clippingAncestors.length; i16++) {
    const rect = getClientRectFromClippingAncestor(element, clippingAncestors[i16], strategy);
