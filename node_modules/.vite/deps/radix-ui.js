...
function useSize(element) {
  const [size2, setSize] = React39.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
var PopperAnchor = React42.forwardRef(
  (props, forwardedRef) => {
...
var PopperContent = React42.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopper,
      side = "bottom",
    ...
    const [arrow2, setArrow] = React42.useState(null);
...
var Form = React48.forwardRef(
  (props, forwardedRef) => {
    ...
    const [validityMap, setValidityMap] = React48.useState({});
    const getFieldValidity = React48.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React48.useCallback(
    ...
    const handleFieldValiditionClear = React48.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React48.useState({});
    const getFieldCustomMatcherEntries = React48.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React48.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React48.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React48.useState({});
    const getFieldCustomErrors = React48.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React48.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React48.useState({});
    const handleFieldMessageIdAdd = React48.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React48.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React48.useCallback(
...
var FormField = React48.forwardRef(
  (props, forwardedRef) => {
...
var FormControl = React48.forwardRef(
  (props, forwardedRef) => {
    ...
    const updateControlValidity = React48.useCallback(
      async (control) => {
    ...
    const resetControlValidity = React48.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormBuiltInMessage = React48.forwardRef(
  (props, forwardedRef) => {
...
var FormCustomMessage = React48.forwardRef(
  (props, forwardedRef) => {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React48.useMemo(() => ({ id, match }), [id, match]);
...
var FormMessageImpl = React48.forwardRef(
  (props, forwardedRef) => {
...
var FormSubmit = React48.forwardRef(
  (props, forwardedRef) => {
...
var HoverCard = (props) => {
  ...
  const hasSelectionRef = React49.useRef(false);
  const isPointerDownOnContentRef = React49.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  const handleDismiss = React49.useCallback(() => setOpen(false), [setOpen]);
  React49.useEffect(() => {
    return () => {
      clearTimeout(openTimerRef.current);
      clearTimeout(closeTimerRef.current);
...
var HoverCardContentImpl = React49.forwardRef((props, forwardedRef) => {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
    onPointerDownOutside,
  ...
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [containSelection, setContainSelection] = React49.useState(false);
  React49.useEffect(() => {
    if (containSelection) {
...
var HoverCardArrow = React49.forwardRef(
  (props, forwardedRef) => {
...
var Menubar = React50.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React50.useState(null);
    return (0, import_jsx_runtime28.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React50.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React50.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React50.useCallback(
          (value2) => {
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React50.useRef(false);
...
var MenubarTrigger = React50.forwardRef(
  (props, forwardedRef) => {
...
var MenubarGroup = React50.forwardRef(
  (props, forwardedRef) => {
...
var MenubarLabel = React50.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItem = React50.forwardRef(
  (props, forwardedRef) => {
...
var MenubarCheckboxItem = React50.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioGroup = React50.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioItem = React50.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItemIndicator = React50.forwardRef((props, forwardedRef) => {
...
var MenubarSeparator = React50.forwardRef(
  (props, forwardedRef) => {
...
var MenubarArrow = React50.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubTrigger = React50.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React50.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenu = React51.forwardRef(
  (props, forwardedRef) => {
    const {
    ...
    const [navigationMenu, setNavigationMenu] = React51.useState(null);
    const composedRef = useComposedRefs(forwardedRef, (node) => setNavigationMenu(node));
    const direction = useDirection(dir);
    const openTimerRef = React51.useRef(0);
    const closeTimerRef = React51.useRef(0);
    const skipDelayTimerRef = React51.useRef(0);
    const [isOpenDelayed, setIsOpenDelayed] = React51.useState(true);
    const [value, setValue] = useControllableState({
      prop: valueProp,
      onChange: (value2) => {
        const isOpen = value2 !== "";
    ...
    const startCloseTimer = React51.useCallback(() => {
    ...
    const handleDelayedOpen = React51.useCallback(
      (itemValue) => {
...
var NavigationMenuSub = React51.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeNavigationMenu,
      value: valueProp,
...
var NavigationMenuProvider = (props) => {
  ...
  const [viewportContent, setViewportContent] = React51.useState(/* @__PURE__ */ new Map());
  const [indicatorTrack, setIndicatorTrack] = React51.useState(null);
  return (0, import_jsx_runtime29.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      onViewportContentChange: React51.useCallback((contentValue, contentData) => {
        setViewportContent((prevContent) => {
          prevContent.set(contentValue, contentData);
          return new Map(prevContent);
        });
      }, []),
      onViewportContentRemove: React51.useCallback((contentValue) => {
        setViewportContent((prevContent) => {
...
var NavigationMenuList = React51.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuItem = React51.forwardRef(
  (props, forwardedRef) => {
    ...
    const focusProxyRef = React51.useRef(null);
    const restoreContentTabOrderRef = React51.useRef(() => {
    });
    const wasEscapeCloseRef = React51.useRef(false);
    const handleContentEntry = React51.useCallback((side = "start") => {
    ...
    const handleContentExit = React51.useCallback(() => {
      if (contentRef.current) {
        const candidates = getTabbableCandidates2(contentRef.current);
...
var NavigationMenuTrigger = React51.forwardRef((props, forwardedRef) => {
  ...
  const hasPointerMoveOpenedRef = React51.useRef(false);
  const wasClickCloseRef = React51.useRef(false);
...
var NavigationMenuLink = React51.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuIndicator = React51.forwardRef((props, forwardedRef) => {
...
var NavigationMenuIndicatorImpl = React51.forwardRef((props, forwardedRef) => {
  ...
  const [activeTrigger, setActiveTrigger] = React51.useState(
    null
  );
  const [position, setPosition] = React51.useState(null);
...
var NavigationMenuContent = React51.forwardRef((props, forwardedRef) => {
  const { forceMount, ...contentProps } = props;
...
var ViewportContentMounter = React51.forwardRef((props, forwardedRef) => {
  const context = useNavigationMenuContext(CONTENT_NAME11, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React51.forwardRef((props, forwardedRef) => {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
  ...
  const getItems = useCollection5(__scopeNavigationMenu);
  const prevMotionAttributeRef = React51.useRef(null);
  ...
  const motionAttribute = React51.useMemo(() => {
    const items = getItems();
...
var NavigationMenuViewport = React51.forwardRef((props, forwardedRef) => {
...
var NavigationMenuViewportImpl = React51.forwardRef((props, forwardedRef) => {
  ...
  const [size2, setSize] = React51.useState(null);
...
var FocusGroup = React51.forwardRef(
  (props, forwardedRef) => {
...
var FocusGroupItem = React51.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
...
var OneTimePasswordField = React52.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React52.useCallback(
      (value2) => {
    ...
    const controlledValue = React52.useMemo(() => {
    ...
    const validationTypeRef = React52.useRef(validation);
    React52.useEffect(() => {
      if (!validation) {
        return;
      }
    ...
    const hiddenInputRef = React52.useRef(null);
    const userActionRef = React52.useRef(null);
    ...
    const locateForm = React52.useCallback(() => {
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React52.useCallback(() => {
    ...
    const valueRef = React52.useRef(currentValue);
...
var OneTimePasswordFieldHiddenInput = React52.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React52.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React52.useState(null);
  ...
  const keyboardActionTimeoutRef = React52.useRef(null);
  React52.useEffect(() => {
    return () => {
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React53.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React53.useCallback(
  ...
  const focusState = React53.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React53.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React53.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React53.useState(void 0);
...
var PasswordToggleFieldIcon = React53.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
...
var Progress = React55.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeProgress,
    ...
    return (0, import_jsx_runtime33.jsx)(ProgressProvider, { scope: __scopeProgress, value, max, children: (0, import_jsx_runtime33.jsx)(
      Primitive.div,
      {
        "aria-valuemax": max,
        "aria-valuemin": 0,
...
var ProgressIndicator = React55.forwardRef(
  (props, forwardedRef) => {
...
var Radio = React56.forwardRef(
  (props, forwardedRef) => {
    ...
    const [button, setButton] = React56.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setButton(node));
    const hasConsumerStoppedPropagationRef = React56.useRef(false);
...
var RadioIndicator = React56.forwardRef(
  (props, forwardedRef) => {
...
var RadioBubbleInput = React56.forwardRef(
  ({
    __scopeRadio,
    control,
    checked,
...
var Select = (props) => {
  ...
  const [trigger, setTrigger] = React58.useState(null);
  const [valueNode, setValueNode] = React58.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React58.useState(false);
  const direction = useDirection(dir);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
  ...
  const triggerPointerDownPosRef = React58.useRef(null);
  const isFormControl2 = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React58.useState(/* @__PURE__ */ new Set());
      ...
      children: [
        (0, import_jsx_runtime37.jsx)(Collection7.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime37.jsx)(
          SelectNativeOptionsProvider,
          {
            ...
            onNativeOptionAdd: React58.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React58.useCallback((option) => {
...
var SelectTrigger = React58.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React58.useRef("touch");
...
var SelectValue = React58.forwardRef(
  (props, forwardedRef) => {
...
var SelectIcon = React58.forwardRef(
  (props, forwardedRef) => {
...
var SelectContent = React58.forwardRef(
  (props, forwardedRef) => {
    const context = useSelectContext(CONTENT_NAME13, props.__scopeSelect);
    const [fragment, setFragment] = React58.useState();
    useLayoutEffect2(() => {
...
var SelectContentImpl = React58.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const [viewport, setViewport] = React58.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React58.useState(null);
    const [selectedItemText, setSelectedItemText] = React58.useState(
      null
    );
    const getItems = useCollection7(__scopeSelect);
    const [isPositioned, setIsPositioned] = React58.useState(false);
    const firstValidItemFoundRef = React58.useRef(false);
    React58.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst6 = React58.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React58.useCallback(
    ...
    const itemRefCallback = React58.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React58.useCallback(() => content?.focus(), [content]);
    const itemTextRefCallback = React58.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
...
var SelectItemAlignedPosition = React58.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME13, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME13, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React58.useState(null);
  const [content, setContent] = React58.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection7(__scopeSelect);
  const shouldExpandOnScrollRef = React58.useRef(false);
  const shouldRepositionRef = React58.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React58.useCallback(() => {
  ...
  const handleScrollButtonChange = React58.useCallback(
    (node) => {
...
var SelectPopperPosition = React58.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React58.forwardRef(
  (props, forwardedRef) => {
    ...
    const prevScrollTopRef = React58.useRef(0);
...
var SelectGroup = React58.forwardRef(
  (props, forwardedRef) => {
...
var SelectLabel = React58.forwardRef(
  (props, forwardedRef) => {
...
var SelectItem = React58.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
      value,
    ...
    const [textValue, setTextValue] = React58.useState(textValueProp ?? "");
    ...
    return (0, import_jsx_runtime37.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React58.useCallback((node) => {
...
var SelectItemText = React58.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React58.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React58.useMemo(
...
var SelectItemIndicator = React58.forwardRef(
  (props, forwardedRef) => {
...
var SelectScrollUpButton = React58.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React58.useState(false);
...
var SelectScrollDownButton = React58.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React58.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
...
var SelectScrollButtonImpl = React58.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React58.useRef(null);
  const getItems = useCollection7(__scopeSelect);
  const clearAutoScrollTimer = React58.useCallback(() => {
...
var SelectSeparator = React58.forwardRef(
  (props, forwardedRef) => {
...
var SelectArrow = React58.forwardRef(
  (props, forwardedRef) => {
...
var SelectBubbleInput = React58.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React58.useCallback(
    (key) => {
      const search = searchRef.current + key;
  ...
  const resetTypeahead = React58.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React58.useEffect(() => {
...
var Separator4 = React59.forwardRef((props, forwardedRef) => {
...
var Slider = React60.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React60.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React60.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React60.useRef(values);
...
var SliderHorizontal = React60.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
    ...
    const [slider, setSlider] = React60.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React60.useRef(void 0);
    const direction = useDirection(dir);
    const isDirectionLTR = direction === "ltr";
...
var SliderVertical = React60.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
...
var SliderImpl = React60.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React60.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React60.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React60.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection8(props.__scopeSlider);
    const [thumb, setThumb] = React60.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index = React60.useMemo(
      () => thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1,
      [getItems, thumb]
    );
    return (0, import_jsx_runtime39.jsx)(SliderThumbImpl, { ...props, ref: composedRefs, index });
  }
);
var SliderThumbImpl = React60.forwardRef(
  (props, forwardedRef) => {
...
var SliderBubbleInput = React60.forwardRef(
...
function getThumbInBoundsOffset(width, left, direction) {
  ...
  const offset2 = linearScale2([0, halfPercent], [0, halfWidth]);
...
var Switch = React61.forwardRef(
  (props, forwardedRef) => {
    ...
    const [button, setButton] = React61.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setButton(node));
    const hasConsumerStoppedPropagationRef = React61.useRef(false);
    const isFormControl2 = button ? form || !!button.closest("form") : true;
    const [checked, setChecked] = useControllableState({
      prop: checkedProp,
      defaultProp: defaultChecked ?? false,
...
var SwitchThumb = React61.forwardRef(
  (props, forwardedRef) => {
...
var SwitchBubbleInput = React61.forwardRef(
  ({
    __scopeSwitch,
    control,
    checked,
...
var TabsList = React62.forwardRef(
  (props, forwardedRef) => {
...
var TabsTrigger = React62.forwardRef(
  (props, forwardedRef) => {
...
var TabsContent = React62.forwardRef(
  (props, forwardedRef) => {
    ...
    const contentId = makeContentId2(context.baseId, value);
    const isSelected = value === context.value;
    const isMountAnimationPreventedRef = React62.useRef(isSelected);
    React62.useEffect(() => {
      const rAF = requestAnimationFrame(() => isMountAnimationPreventedRef.current = false);
      return () => cancelAnimationFrame(rAF);
    }, []);
...
var ToastProvider = (props) => {
  ...
  const [viewport, setViewport] = React63.useState(null);
  const [toastCount, setToastCount] = React63.useState(0);
  const isFocusedToastEscapeKeyDownRef = React63.useRef(false);
  const isClosePausedRef = React63.useRef(false);
  if (!label.trim()) {
    console.error(
  ...
  return (0, import_jsx_runtime42.jsx)(Collection9.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime42.jsx)(
    ToastProviderProvider,
    {
      ...
      viewport,
      onViewportChange: setViewport,
      onToastAdd: React63.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React63.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React63.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const headFocusProxyRef = React63.useRef(null);
    const tailFocusProxyRef = React63.useRef(null);
    ...
    const getSortedTabbableCandidates = React63.useCallback(
      ({ tabbingDirection }) => {
      ...
      if (viewport) {
        const handleKeyDown = (event) => {
          ...
          if (isTabKey) {
            ...
            if (focusFirst5(sortedCandidates.slice(index + 1))) {
              event.preventDefault();
            } else {
...
var FocusProxy = React63.forwardRef(
  (props, forwardedRef) => {
...
var ToastImpl = React63.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const [node, setNode] = React63.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React63.useRef(null);
    const swipeDeltaRef = React63.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React63.useRef(0);
    const closeTimerRemainingTimeRef = React63.useRef(duration);
    ...
    const startTimer = React63.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React63.useMemo(() => {
    ...
    return (0, import_jsx_runtime42.jsxs)(import_jsx_runtime42.Fragment, { children: [
      ...
      (0, import_jsx_runtime42.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM5.createPortal(
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React63.useState(false);
  const [isAnnounced, setIsAnnounced] = React63.useState(false);
...
var ToastTitle = React63.forwardRef(
  (props, forwardedRef) => {
...
var ToastDescription = React63.forwardRef(
  (props, forwardedRef) => {
...
var ToastAction = React63.forwardRef(
  (props, forwardedRef) => {
...
var ToastClose = React63.forwardRef(
  (props, forwardedRef) => {
...
var ToastAnnounceExclude = React63.forwardRef((props, forwardedRef) => {
...
var NAME7 = "Toggle";
var Toggle = React64.forwardRef((props, forwardedRef) => {
...
var Toolbar = React66.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarSeparator = React66.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React66.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarLink = React66.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleGroup = React66.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React66.forwardRef(
  (props, forwardedRef) => {
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React67.useRef(true);
  const isPointerInTransitRef = React67.useRef(false);
  ...
  return (0, import_jsx_runtime46.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React67.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React67.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        skipDelayTimerRef.current = window.setTimeout(
      ...
      onPointerInTransitChange: React67.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const [trigger, setTrigger] = React67.useState(null);
  const contentId = useId();
  const openTimerRef = React67.useRef(0);
  const disableHoverableContent = disableHoverableContentProp ?? providerContext.disableHoverableContent;
  const delayDuration = delayDurationProp ?? providerContext.delayDuration;
  const wasOpenDelayedRef = React67.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React67.useMemo(() => {
  ...
  return (0, import_jsx_runtime46.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime46.jsx)(
    TooltipContextProvider,
    {
      ...
      trigger,
      onTriggerChange: setTrigger,
      onTriggerEnter: React67.useCallback(() => {
        if (providerContext.isOpenDelayedRef.current) handleDelayedOpen();
        else handleOpen();
      }, [providerContext.isOpenDelayedRef, handleDelayedOpen, handleOpen]),
      onTriggerLeave: React67.useCallback(() => {
...
var TooltipTrigger = React67.forwardRef(
  (props, forwardedRef) => {
    ...
    const isPointerDownRef = React67.useRef(false);
    const hasPointerMoveOpenedRef = React67.useRef(false);
    const handlePointerUp = React67.useCallback(() => isPointerDownRef.current = false, []);
    React67.useEffect(() => {
...
var TooltipContent = React67.forwardRef(
  (props, forwardedRef) => {
...
var TooltipContentHoverable = React67.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME15, props.__scopeTooltip);
  const ref = React67.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React67.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React67.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React67.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React67.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
...
var TooltipArrow = React67.forwardRef(
  (props, forwardedRef) => {
